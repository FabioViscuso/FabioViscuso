    ...
    <main className="relative text-gray-100 flex flex-col justify-center items-center h-full text-center lg:text-left">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-20">
          ...
          <div className="flex flex-col align-center justify-center">
            ...
            <p className="mt-12 text-xl lg:text-4xl">{t("intro-line1")}</p>
        ...
        <article className="h-full flex flex-col justify-between items-center gap-24">
          <div className="flex flex-col lg:flex-row justify-center items-center gap-24">
            <div className="lg:flex-1">
              ...
              />
              <p className="my-8 text-lg">{t("section-2-line1")}</p>
              <p className="mb-8 text-lg">{t("section-2-line2")}</p>
              <p className="text-lg">
                {t("section-2-line3")}
                <span>
                  &nbsp;
      ...
      >
        <article className="h-full flex flex-col lg:flex-row justify-center items-center gap-32 lg:gap-24">
          <div className="lg:flex-1">
            ...
            />
            <p className="mt-8 text-lg">{t("section-3-p1")}</p>
            <p className="mt-8 text-lg">{t("section-3-p2")}</p>
            <p className="mt-8 text-lg">{t("section-3-p3")}</p>
          </div>
      ...
      >
        <div className="flex flex-col flex-1 ">
          ...
          />
          <p className="mt-8 mb-8 md:mb-0 text-2xl">{t("contacts-line1")}</p>
          <p className="mt-8 mb-8 md:mb-0 text-2xl">{t("contacts-line2")}</p>
        </div>
